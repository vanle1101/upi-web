...
<head>
    ...
    <title data-i18n="app_title">Dashboard | Gpt Signup Hybrid</title>
</head>
...
HTML_SIDEBAR = """
        ...
        <aside class="sidebar">
            <div class="sidebar-header">
                <h2 class="brand"><span class="brand-highlight">GPT</span> Signup</h2>
            </div>
            <nav class="sidebar-nav">
                <button class="nav-item active" data-tab="tab-reg">
                   <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
                   <span data-i18n="nav_reg">Registration</span>
                </button>
                <button class="nav-item" data-tab="tab-session">
                   <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                   <span data-i18n="nav_session">Sessions</span>
                </button>
                <button class="nav-item" data-tab="tab-upi">
                   ...
                   <span data-i18n="nav_upi">UPI Operations</span>
                </button>
                <button class="nav-item" data-tab="tab-getacc">
                   <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
                   <span data-i18n="nav_getacc">Get Accounts</span>
                </button>
                <button class="nav-item" data-tab="tab-link">
                   <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg>
                   <span data-i18n="nav_link">Link Gen</span>
                </button>
                <button class="nav-item" data-tab="tab-hme">
                   ...
                   <span data-i18n="nav_hme">HME Manager</span>
                </button>
            ...
            <header class="top-header">
                ...
                <div class="header-right">
                    <div class="lang-selector">
                        <select id="lang-toggle" class="header-select">
...
with open("test/build_ui_1.py", "w", encoding="utf-8") as f:
    f.write(f"HTML_HEAD = {repr(HTML_HEAD)}\n")
    f.write(f"HTML_SIDEBAR = {repr(HTML_SIDEBAR)}\n")
    f.write(f"HTML_HEADER = {repr(HTML_HEADER)}\n")
